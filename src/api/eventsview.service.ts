...
import { Item66 } from '../model/item66';
import { Item67 } from '../model/item67';
import { Item68 } from '../model/item68';
...
export class EventsviewService {
  ...
  public eventsviewGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20021>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/eventsview`, {
   ...
   */
  public eventsviewIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling eventsviewIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/eventsview/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public eventsviewIdGet(id: string): Observable<InlineResponse20021> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling eventsviewIdGet.'
      );
    }
   ...
   */
  public eventsviewIdPatch(id: string, item: Item68): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling eventsviewIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling eventsviewIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public eventsviewIdPut(id: string, item: Item67): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling eventsviewIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling eventsviewIdPut.'
      );
    }
   ...
   */
  public eventsviewPost(item: Item66): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling eventsviewPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/eventsview`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
