...
import { Item33 } from '../model/item33';
import { Item34 } from '../model/item34';
import { Item35 } from '../model/item35';
...
export class CountryService {
   ...
   */
  public countryIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling countryIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/country/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public countryIdGet(id: string): Observable<InlineResponse20011> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling countryIdGet.'
      );
    }
   ...
   */
  public countryIdPatch(id: string, item: Item35): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling countryIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling countryIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public countryIdPut(id: string, item: Item34): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling countryIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling countryIdPut.'
      );
    }
   ...
   */
  public countryPost(item: Item33): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling countryPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/country`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
