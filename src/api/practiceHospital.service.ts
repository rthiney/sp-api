...
import { Item100 } from '../model/item100';
import { Item101 } from '../model/item101';
import { Item99 } from '../model/item99';
...
@Injectable()
export class PracticeHospitalService {
  ...
  public practiceHospitalGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20032>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/practice_hospital`, {
   ...
   */
  public practiceHospitalIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceHospitalIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/practice_hospital/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public practiceHospitalIdGet(id: string): Observable<InlineResponse20032> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceHospitalIdGet.'
      );
    }
   ...
   */
  public practiceHospitalIdPatch(
    id: string,
    item: Item101
  ): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceHospitalIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling practiceHospitalIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public practiceHospitalIdPut(id: string, item: Item100): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceHospitalIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling practiceHospitalIdPut.'
      );
    }
   ...
   */
  public practiceHospitalPost(item: Item99): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling practiceHospitalPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/practice_hospital`,
      item,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
