...
import { Item135 } from '../model/item135';
import { Item136 } from '../model/item136';
import { Item137 } from '../model/item137';
...
@Injectable()
export class SurgeryStatusService {
  ...
  public surgeryStatusGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20044>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/surgery_status`, {
   ...
   */
  public surgeryStatusIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryStatusIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/surgery_status/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public surgeryStatusIdGet(id: string): Observable<InlineResponse20044> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryStatusIdGet.'
      );
    }
   ...
   */
  public surgeryStatusIdPatch(id: string, item: Item137): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryStatusIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeryStatusIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public surgeryStatusIdPut(id: string, item: Item136): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryStatusIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeryStatusIdPut.'
      );
    }
   ...
   */
  public surgeryStatusPost(item: Item135): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeryStatusPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/surgery_status`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
