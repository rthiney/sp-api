...
import { Item147 } from '../model/item147';
import { Item148 } from '../model/item148';
import { Item149 } from '../model/item149';
...
@Injectable()
export class VendordataUserService {
  ...
  public vendordataUserGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20048>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/vendordata_user`, {
   ...
   */
  public vendordataUserIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendordataUserIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/vendordata_user/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public vendordataUserIdGet(id: string): Observable<InlineResponse20048> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendordataUserIdGet.'
      );
    }
   ...
   */
  public vendordataUserIdPatch(id: string, item: Item149): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendordataUserIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling vendordataUserIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public vendordataUserIdPut(id: string, item: Item148): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendordataUserIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling vendordataUserIdPut.'
      );
    }
   ...
   */
  public vendordataUserPost(item: Item147): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling vendordataUserPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/vendordata_user`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
