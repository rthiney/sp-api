...
import { Item84 } from '../model/item84';
import { Item85 } from '../model/item85';
import { Item86 } from '../model/item86';
...
export class GroupService {
  ...
  public groupGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20027>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/group`, {
   ...
   */
  public groupIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling groupIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/group/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public groupIdGet(id: string): Observable<InlineResponse20027> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling groupIdGet.'
      );
    }
   ...
   */
  public groupIdPatch(id: string, item: Item86): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling groupIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling groupIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public groupIdPut(id: string, item: Item85): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling groupIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling groupIdPut.'
      );
    }
   ...
   */
  public groupPost(item: Item84): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling groupPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/group`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
