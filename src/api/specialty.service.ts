...
import { Item114 } from '../model/item114';
import { Item115 } from '../model/item115';
import { Item116 } from '../model/item116';
...
export class SpecialtyService {
  ...
  public specialtyGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20037>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/specialty`, {
   ...
   */
  public specialtyIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling specialtyIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/specialty/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public specialtyIdGet(id: string): Observable<InlineResponse20037> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling specialtyIdGet.'
      );
    }
   ...
   */
  public specialtyIdPatch(id: string, item: Item116): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling specialtyIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling specialtyIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public specialtyIdPut(id: string, item: Item115): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling specialtyIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling specialtyIdPut.'
      );
    }
   ...
   */
  public specialtyPost(item: Item114): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling specialtyPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/specialty`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
