...
import { Item24 } from '../model/item24';
import { Item25 } from '../model/item25';
import { Item26 } from '../model/item26';
...
export class ClusterService {
  ...
  public clusterGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse2008>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/cluster`, {
   ...
   */
  public clusterIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/cluster/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public clusterIdGet(id: string): Observable<InlineResponse2008> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterIdGet.'
      );
    }
   ...
   */
  public clusterIdPatch(id: string, item: Item26): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling clusterIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public clusterIdPut(id: string, item: Item25): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling clusterIdPut.'
      );
    }
   ...
   */
  public clusterPost(item: Item24): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling clusterPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/cluster`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
