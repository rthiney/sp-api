...
import { Item48 } from '../model/item48';
import { Item49 } from '../model/item49';
import { Item50 } from '../model/item50';
...
@Injectable()
export class DoctorMessageService {
  ...
  public doctorMessageGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20015>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/doctor_message`, {
   ...
   */
  public doctorMessageIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorMessageIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/doctor_message/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public doctorMessageIdGet(id: string): Observable<InlineResponse20015> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorMessageIdGet.'
      );
    }
   ...
   */
  public doctorMessageIdPatch(id: string, item: Item50): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorMessageIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorMessageIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public doctorMessageIdPut(id: string, item: Item49): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorMessageIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorMessageIdPut.'
      );
    }
   ...
   */
  public doctorMessagePost(item: Item48): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorMessagePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/doctor_message`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
