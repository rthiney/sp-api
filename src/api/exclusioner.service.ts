...
import { Item69 } from '../model/item69';
import { Item70 } from '../model/item70';
import { Item71 } from '../model/item71';
...
@Injectable()
export class ExclusionerService {
  ...
  public exclusionerGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20022>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/exclusioner`, {
   ...
   */
  public exclusionerIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling exclusionerIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/exclusioner/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public exclusionerIdGet(id: string): Observable<InlineResponse20022> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling exclusionerIdGet.'
      );
    }
   ...
   */
  public exclusionerIdPatch(id: string, item: Item71): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling exclusionerIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling exclusionerIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public exclusionerIdPut(id: string, item: Item70): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling exclusionerIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling exclusionerIdPut.'
      );
    }
   ...
   */
  public exclusionerPost(item: Item69): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling exclusionerPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/exclusioner`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
