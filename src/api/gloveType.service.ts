...
import { Item78 } from '../model/item78';
import { Item79 } from '../model/item79';
import { Item80 } from '../model/item80';
...
export class GloveTypeService {
  ...
  public gloveTypeGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20025>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/glove_type`, {
   ...
   */
  public gloveTypeIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveTypeIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/glove_type/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public gloveTypeIdGet(id: string): Observable<InlineResponse20025> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveTypeIdGet.'
      );
    }
   ...
   */
  public gloveTypeIdPatch(id: string, item: Item80): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveTypeIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling gloveTypeIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public gloveTypeIdPut(id: string, item: Item79): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveTypeIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling gloveTypeIdPut.'
      );
    }
   ...
   */
  public gloveTypePost(item: Item78): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling gloveTypePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/glove_type`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
