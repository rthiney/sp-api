...
import { Item120 } from '../model/item120';
import { Item121 } from '../model/item121';
import { Item122 } from '../model/item122';
...
@Injectable()
export class SurgeriesviewService {
  ...
  public surgeriesviewGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20039>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/surgeriesview`, {
   ...
   */
  public surgeriesviewIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/surgeriesview/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public surgeriesviewIdGet(id: string): Observable<InlineResponse20039> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewIdGet.'
      );
    }
   ...
   */
  public surgeriesviewIdPatch(id: string, item: Item122): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeriesviewIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public surgeriesviewIdPut(id: string, item: Item121): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeriesviewIdPut.'
      );
    }
   ...
   */
  public surgeriesviewPost(item: Item120): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeriesviewPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/surgeriesview`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
