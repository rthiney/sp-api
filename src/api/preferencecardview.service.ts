...
import { Item102 } from '../model/item102';
import { Item103 } from '../model/item103';
import { Item104 } from '../model/item104';
...
@Injectable()
export class PreferencecardviewService {
  ...
  public preferencecardviewGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20033>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/preferencecardview`, {
   ...
   */
  public preferencecardviewIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling preferencecardviewIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/preferencecardview/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public preferencecardviewIdGet(id: string): Observable<InlineResponse20033> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling preferencecardviewIdGet.'
      );
    }
   ...
   */
  public preferencecardviewIdPatch(
    id: string,
    item: Item104
  ): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling preferencecardviewIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling preferencecardviewIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public preferencecardviewIdPut(
    id: string,
    item: Item103
  ): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling preferencecardviewIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling preferencecardviewIdPut.'
      );
    }
   ...
   */
  public preferencecardviewPost(item: Item102): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling preferencecardviewPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/preferencecardview`,
      item,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
