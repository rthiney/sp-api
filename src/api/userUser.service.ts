...
import { Item141 } from '../model/item141';
import { Item142 } from '../model/item142';
import { Item143 } from '../model/item143';
...
export class UserUserService {
  ...
  public userUserGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20046>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/user_user`, {
   ...
   */
  public userUserIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling userUserIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/user_user/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public userUserIdGet(id: string): Observable<InlineResponse20046> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling userUserIdGet.'
      );
    }
   ...
   */
  public userUserIdPatch(id: string, item: Item143): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling userUserIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling userUserIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public userUserIdPut(id: string, item: Item142): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling userUserIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling userUserIdPut.'
      );
    }
   ...
   */
  public userUserPost(item: Item141): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling userUserPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/user_user`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
