...
import { Item123 } from '../model/item123';
import { Item124 } from '../model/item124';
import { Item125 } from '../model/item125';
...
@Injectable()
export class SurgeriesviewcodesService {
  ...
  public surgeriesviewcodesGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20040>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/surgeriesviewcodes`, {
   ...
   */
  public surgeriesviewcodesIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewcodesIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/surgeriesviewcodes/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public surgeriesviewcodesIdGet(id: string): Observable<InlineResponse20040> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewcodesIdGet.'
      );
    }
   ...
   */
  public surgeriesviewcodesIdPatch(
    id: string,
    item: Item125
  ): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewcodesIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeriesviewcodesIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public surgeriesviewcodesIdPut(
    id: string,
    item: Item124
  ): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeriesviewcodesIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeriesviewcodesIdPut.'
      );
    }
   ...
   */
  public surgeriesviewcodesPost(item: Item123): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeriesviewcodesPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/surgeriesviewcodes`,
      item,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
