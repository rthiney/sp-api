...
import { Item15 } from '../model/item15';
import { Item16 } from '../model/item16';
import { Item17 } from '../model/item17';
...
export class AttachmentService {
  ...
  public attachmentGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse2005>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/attachment`, {
   ...
   */
  public attachmentIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling attachmentIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/attachment/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public attachmentIdGet(id: string): Observable<InlineResponse2005> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling attachmentIdGet.'
      );
    }
   ...
   */
  public attachmentIdPatch(id: string, item: Item17): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling attachmentIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling attachmentIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public attachmentIdPut(id: string, item: Item16): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling attachmentIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling attachmentIdPut.'
      );
    }
   ...
   */
  public attachmentPost(item: Item15): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling attachmentPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/attachment`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
