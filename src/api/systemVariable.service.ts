...
import { Item138 } from '../model/item138';
import { Item139 } from '../model/item139';
import { Item140 } from '../model/item140';
...
export class SystemVariableService {
  ...
  public systemVariableGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20045>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/system_variable`, {
   ...
   */
  public systemVariableIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemVariableIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/system_variable/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public systemVariableIdGet(id: string): Observable<InlineResponse20045> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemVariableIdGet.'
      );
    }
   ...
   */
  public systemVariableIdPatch(id: string, item: Item140): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemVariableIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling systemVariableIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public systemVariableIdPut(id: string, item: Item139): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemVariableIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling systemVariableIdPut.'
      );
    }
   ...
   */
  public systemVariablePost(item: Item138): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling systemVariablePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/system_variable`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
