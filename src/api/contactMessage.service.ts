...
import { Item30 } from '../model/item30';
import { Item31 } from '../model/item31';
import { Item32 } from '../model/item32';
...
export class ContactMessageService {
  ...
  public contactMessageGet(
    ...
    return this.httpClient.get<any>(`${this.basePath}/contact_message`, {
   ...
   */
  public contactMessageIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling contactMessageIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/contact_message/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public contactMessageIdGet(id: string): Observable<InlineResponse20010> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling contactMessageIdGet.'
      );
    }
   ...
   */
  public contactMessageIdPatch(id: string, item: Item32): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling contactMessageIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling contactMessageIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public contactMessageIdPut(id: string, item: Item31): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling contactMessageIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling contactMessageIdPut.'
      );
    }
   ...
   */
  public contactMessagePost(item: Item30): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling contactMessagePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/contact_message`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
