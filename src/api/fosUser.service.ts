...
import { Item72 } from '../model/item72';
import { Item73 } from '../model/item73';
import { Item74 } from '../model/item74';
...
export class FosUserService {
  ...
  public fosUserGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20023>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/fos_user`, {
   ...
   */
  public fosUserIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling fosUserIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/fos_user/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public fosUserIdGet(id: string): Observable<InlineResponse20023> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling fosUserIdGet.'
      );
    }
   ...
   */
  public fosUserIdPatch(id: string, item: Item74): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling fosUserIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling fosUserIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public fosUserIdPut(id: string, item: Item73): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling fosUserIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling fosUserIdPut.'
      );
    }
   ...
   */
  public fosUserPost(item: Item72): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling fosUserPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/fos_user`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
