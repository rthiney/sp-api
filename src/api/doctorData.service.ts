...
import { Item42 } from '../model/item42';
import { Item43 } from '../model/item43';
import { Item44 } from '../model/item44';
...
export class DoctorDataService {
  ...
  public doctorDataGet(
    ...
    return this.httpClient.get<any>(`${this.basePath}/doctor_data`, {
   ...
   */
  public doctorDataIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorDataIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/doctor_data/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public doctorDataIdGet(id: string): Observable<InlineResponse20013> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorDataIdGet.'
      );
    }
   ...
   */
  public doctorDataIdPatch(id: string, item: Item44): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorDataIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorDataIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public doctorDataIdPut(id: string, item: Item43): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorDataIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorDataIdPut.'
      );
    }
   ...
   */
  public doctorDataPost(item: Item42): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorDataPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/doctor_data`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
