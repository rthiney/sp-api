...
import { Item63 } from '../model/item63';
import { Item64 } from '../model/item64';
import { Item65 } from '../model/item65';
...
export class EventsService {
  ...
  public eventsGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20020>> {
   ...
   */
  public eventsIdDelete(id: string): Observable<number> {
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/events/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public eventsIdGet(id: string): Observable<InlineResponse20020> {
    if (id === null || id === undefined) {
      throw new Error(
   ...
   */
  public eventsIdPatch(id: string, item: Item65): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
    ...
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling eventsIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public eventsIdPut(id: string, item: Item64): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling eventsIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling eventsIdPut.'
      );
    }
   ...
   */
  public eventsPost(item: Item63): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling eventsPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/events`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
