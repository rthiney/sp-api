...
import { Item117 } from '../model/item117';
import { Item118 } from '../model/item118';
import { Item119 } from '../model/item119';
...
export class StateService {
  ...
  public stateGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20038>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/state`, {
   ...
   */
  public stateIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling stateIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/state/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public stateIdGet(id: string): Observable<InlineResponse20038> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling stateIdGet.'
      );
    }
   ...
   */
  public stateIdPatch(id: string, item: Item119): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling stateIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling stateIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public stateIdPut(id: string, item: Item118): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling stateIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling stateIdPut.'
      );
    }
   ...
   */
  public statePost(item: Item117): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling statePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/state`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
