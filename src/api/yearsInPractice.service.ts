...
import { Item150 } from '../model/item150';
import { Item151 } from '../model/item151';
import { Item152 } from '../model/item152';
...
@Injectable()
export class YearsInPracticeService {
  ...
  public yearsInPracticeGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20049>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/years_in_practice`, {
   ...
   */
  public yearsInPracticeIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling yearsInPracticeIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/years_in_practice/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public yearsInPracticeIdGet(id: string): Observable<InlineResponse20049> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling yearsInPracticeIdGet.'
      );
    }
   ...
   */
  public yearsInPracticeIdPatch(id: string, item: Item152): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling yearsInPracticeIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling yearsInPracticeIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public yearsInPracticeIdPut(id: string, item: Item151): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling yearsInPracticeIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling yearsInPracticeIdPut.'
      );
    }
   ...
   */
  public yearsInPracticePost(item: Item150): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling yearsInPracticePost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/years_in_practice`,
      item,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
