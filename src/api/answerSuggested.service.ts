...
@Injectable()
export class AnswerSuggestedService {
  ...
  public answerSuggestedGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse2002>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/answer_suggested`, {
   ...
   */
  public answerSuggestedIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answerSuggestedIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/answer_suggested/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public answerSuggestedIdGet(id: string): Observable<InlineResponse2002> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answerSuggestedIdGet.'
      );
    }
   ...
   */
  public answerSuggestedIdPatch(id: string, item: Item8): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answerSuggestedIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling answerSuggestedIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public answerSuggestedIdPut(id: string, item: Item7): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answerSuggestedIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling answerSuggestedIdPut.'
      );
    }
   ...
   */
  public answerSuggestedPost(item: Item6): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling answerSuggestedPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/answer_suggested`,
      item,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
