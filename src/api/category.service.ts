...
import { Item21 } from '../model/item21';
import { Item22 } from '../model/item22';
import { Item23 } from '../model/item23';
...
export class CategoryService {
   ...
   */
  public categoryIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling categoryIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/category/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public categoryIdGet(id: string): Observable<InlineResponse2007> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling categoryIdGet.'
      );
    }
   ...
   */
  public categoryIdPatch(id: string, item: Item23): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling categoryIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling categoryIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public categoryIdPut(id: string, item: Item22): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling categoryIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling categoryIdPut.'
      );
    }
   ...
   */
  public categoryPost(item: Item21): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling categoryPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/category`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
