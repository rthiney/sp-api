...
import { Item12 } from '../model/item12';
import { Item13 } from '../model/item13';
import { Item14 } from '../model/item14';
...
export class ArticleService {
  ...
  public articleGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse2004>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/article`, {
   ...
   */
  public articleIdDelete(id: string): Observable<number> {
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/article/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public articleIdGet(id: string): Observable<InlineResponse2004> {
    if (id === null || id === undefined) {
      throw new Error(
   ...
   */
  public articleIdPatch(id: string, item: Item14): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling articleIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling articleIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public articleIdPut(id: string, item: Item13): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
    ...
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling articleIdPut.'
      );
    }
   ...
   */
  public articlePost(item: Item12): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling articlePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/article`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
