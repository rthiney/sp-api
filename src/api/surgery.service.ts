...
import { Item126 } from '../model/item126';
import { Item127 } from '../model/item127';
import { Item128 } from '../model/item128';
...
export class SurgeryApiService {
  ...
  public surgeryGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20041>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/surgery`, {
   ...
   */
  public surgeryIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/surgery/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public surgeryIdGet(id: string): Observable<InlineResponse20041> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryIdGet.'
      );
    }
   ...
   */
  public surgeryIdPatch(id: string, item: Item128): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeryIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public surgeryIdPut(id: string, item: Item127): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling surgeryIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeryIdPut.'
      );
    }
   ...
   */
  public surgeryPost(item: Item126): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling surgeryPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/surgery`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
