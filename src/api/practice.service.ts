...
import { Item96 } from '../model/item96';
import { Item97 } from '../model/item97';
import { Item98 } from '../model/item98';
...
export class PracticeService {
  ...
  public practiceGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20031>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/practice`, {
   ...
   */
  public practiceIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/practice/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public practiceIdGet(id: string): Observable<InlineResponse20031> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceIdGet.'
      );
    }
   ...
   */
  public practiceIdPatch(id: string, item: Item98): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling practiceIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public practiceIdPut(id: string, item: Item97): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling practiceIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling practiceIdPut.'
      );
    }
   ...
   */
  public practicePost(item: Item96): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling practicePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/practice`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
