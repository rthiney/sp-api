...
import { Item144 } from '../model/item144';
import { Item145 } from '../model/item145';
import { Item146 } from '../model/item146';
...
export class VendorDataService {
  ...
  public vendorDataGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20047>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/vendor_data`, {
   ...
   */
  public vendorDataIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendorDataIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/vendor_data/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public vendorDataIdGet(id: string): Observable<InlineResponse20047> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendorDataIdGet.'
      );
    }
   ...
   */
  public vendorDataIdPatch(id: string, item: Item146): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendorDataIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling vendorDataIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public vendorDataIdPut(id: string, item: Item145): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling vendorDataIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling vendorDataIdPut.'
      );
    }
   ...
   */
  public vendorDataPost(item: Item144): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling vendorDataPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/vendor_data`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
