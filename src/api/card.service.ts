...
import { Item18 } from '../model/item18';
import { Item19 } from '../model/item19';
import { Item20 } from '../model/item20';
...
export class CardService {
  ...
  public cardGet(
    ...
    return this.httpClient.get<any>(`${this.basePath}/card`, {
   ...
   */
  public cardIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cardIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/card/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public cardIdGet(id: string): Observable<InlineResponse2006> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cardIdGet.'
      );
    }
   ...
   */
  public cardIdPatch(id: string, item: Item20): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cardIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling cardIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public cardIdPut(id: string, item: Item19): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cardIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling cardIdPut.'
      );
    }
   ...
   */
  public cardPost(item: Item18): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling cardPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/card`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
