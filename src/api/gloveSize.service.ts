...
import { Item75 } from '../model/item75';
import { Item76 } from '../model/item76';
import { Item77 } from '../model/item77';
...
export class GloveSizeService {
  ...
  public gloveSizeGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20024>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/glove_size`, {
   ...
   */
  public gloveSizeIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveSizeIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/glove_size/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public gloveSizeIdGet(id: string): Observable<InlineResponse20024> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveSizeIdGet.'
      );
    }
   ...
   */
  public gloveSizeIdPatch(id: string, item: Item77): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveSizeIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling gloveSizeIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public gloveSizeIdPut(id: string, item: Item76): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling gloveSizeIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling gloveSizeIdPut.'
      );
    }
   ...
   */
  public gloveSizePost(item: Item75): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling gloveSizePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/glove_size`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
