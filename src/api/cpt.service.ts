...
import { Item36 } from '../model/item36';
import { Item37 } from '../model/item37';
import { Item38 } from '../model/item38';
...
export class CptService {
  ...
  public cptGet(
    ...
    return this.httpClient.get<any>(`${this.basePath}/cpt`, {
   ...
   */
  public cptIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cptIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/cpt/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public cptIdGet(id: string): Observable<InlineResponse20012> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cptIdGet.'
      );
    }
   ...
   */
  public cptIdPatch(id: string, item: Item38): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cptIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling cptIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public cptIdPut(id: string, item: Item37): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling cptIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling cptIdPut.'
      );
    }
   ...
   */
  public cptPost(item: Item36): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling cptPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/cpt`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
