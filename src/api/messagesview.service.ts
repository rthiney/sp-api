...
import { Item93 } from '../model/item93';
import { Item94 } from '../model/item94';
import { Item95 } from '../model/item95';
...
@Injectable()
export class MessagesviewService {
  ...
  public messagesviewGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20030>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/messagesview`, {
   ...
   */
  public messagesviewIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling messagesviewIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/messagesview/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public messagesviewIdGet(id: string): Observable<InlineResponse20030> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling messagesviewIdGet.'
      );
    }
   ...
   */
  public messagesviewIdPatch(id: string, item: Item95): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling messagesviewIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling messagesviewIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public messagesviewIdPut(id: string, item: Item94): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling messagesviewIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling messagesviewIdPut.'
      );
    }
   ...
   */
  public messagesviewPost(item: Item93): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling messagesviewPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/messagesview`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
