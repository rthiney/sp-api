...
export class SystemLogService {
  ...
  public systemLogGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse200>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/SystemLog`, {
   ...
   */
  public systemLogIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemLogIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/SystemLog/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public systemLogIdGet(id: string): Observable<InlineResponse200> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemLogIdGet.'
      );
    }
   ...
   */
  public systemLogIdPatch(id: string, item: Item2): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemLogIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling systemLogIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public systemLogIdPut(id: string, item: Item1): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling systemLogIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling systemLogIdPut.'
      );
    }
   ...
   */
  public systemLogPost(item: Item): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling systemLogPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/SystemLog`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
