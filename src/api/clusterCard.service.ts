...
import { Item27 } from '../model/item27';
import { Item28 } from '../model/item28';
import { Item29 } from '../model/item29';
...
@Injectable()
export class ClusterCardService {
  ...
  public clusterCardGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse2009>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/cluster_card`, {
   ...
   */
  public clusterCardIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterCardIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/cluster_card/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public clusterCardIdGet(id: string): Observable<InlineResponse2009> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterCardIdGet.'
      );
    }
   ...
   */
  public clusterCardIdPatch(id: string, item: Item29): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterCardIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling clusterCardIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public clusterCardIdPut(id: string, item: Item28): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling clusterCardIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling clusterCardIdPut.'
      );
    }
   ...
   */
  public clusterCardPost(item: Item27): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling clusterCardPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/cluster_card`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
