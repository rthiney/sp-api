...
import { Item57 } from '../model/item57';
import { Item58 } from '../model/item58';
import { Item59 } from '../model/item59';
...
@Injectable()
export class DoctorhospitalviewService {
  ...
  public doctorhospitalviewGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20018>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/doctorhospitalview`, {
   ...
   */
  public doctorhospitalviewIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorhospitalviewIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/doctorhospitalview/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public doctorhospitalviewIdGet(id: string): Observable<InlineResponse20018> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorhospitalviewIdGet.'
      );
    }
   ...
   */
  public doctorhospitalviewIdPatch(
    id: string,
    item: Item59
  ): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorhospitalviewIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorhospitalviewIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public doctorhospitalviewIdPut(id: string, item: Item58): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorhospitalviewIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorhospitalviewIdPut.'
      );
    }
   ...
   */
  public doctorhospitalviewPost(item: Item57): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorhospitalviewPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/doctorhospitalview`,
      item,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
