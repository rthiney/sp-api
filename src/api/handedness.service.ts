...
import { Item87 } from '../model/item87';
import { Item88 } from '../model/item88';
import { Item89 } from '../model/item89';
...
export class HandednessService {
  ...
  public handednessGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20028>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/handedness`, {
   ...
   */
  public handednessIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling handednessIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/handedness/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public handednessIdGet(id: string): Observable<InlineResponse20028> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling handednessIdGet.'
      );
    }
   ...
   */
  public handednessIdPatch(id: string, item: Item89): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling handednessIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling handednessIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public handednessIdPut(id: string, item: Item88): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling handednessIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling handednessIdPut.'
      );
    }
   ...
   */
  public handednessPost(item: Item87): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling handednessPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/handedness`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
