...
import { Item60 } from '../model/item60';
import { Item61 } from '../model/item61';
import { Item62 } from '../model/item62';
...
@Injectable()
export class DoctorvendorviewService {
  ...
  public doctorvendorviewGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20019>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/doctorvendorview`, {
   ...
   */
  public doctorvendorviewIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorvendorviewIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/doctorvendorview/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public doctorvendorviewIdGet(id: string): Observable<InlineResponse20019> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorvendorviewIdGet.'
      );
    }
   ...
   */
  public doctorvendorviewIdPatch(id: string, item: Item62): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorvendorviewIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorvendorviewIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public doctorvendorviewIdPut(id: string, item: Item61): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling doctorvendorviewIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorvendorviewIdPut.'
      );
    }
   ...
   */
  public doctorvendorviewPost(item: Item60): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling doctorvendorviewPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/doctorvendorview`,
      item,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
