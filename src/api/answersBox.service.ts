...
import { Item10 } from '../model/item10';
import { Item11 } from '../model/item11';
import { Item9 } from '../model/item9';
...
@Injectable()
export class AnswersBoxService {
  ...
  public answersBoxGet(
    ...
    return this.httpClient.get<any>(`${this.basePath}/answers_box`, {
   ...
   */
  public answersBoxIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answersBoxIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/answers_box/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public answersBoxIdGet(id: string): Observable<InlineResponse2003> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answersBoxIdGet.'
      );
    }
   ...
   */
  public answersBoxIdPatch(id: string, item: Item11): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answersBoxIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling answersBoxIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public answersBoxIdPut(id: string, item: Item10): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling answersBoxIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling answersBoxIdPut.'
      );
    }
   ...
   */
  public answersBoxPost(item: Item9): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling answersBoxPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/answers_box`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
