...
import { Item108 } from '../model/item108';
import { Item109 } from '../model/item109';
import { Item110 } from '../model/item110';
...
export class QuestionTypeService {
  ...
  public questionTypeGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20035>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/question_type`, {
   ...
   */
  public questionTypeIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling questionTypeIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/question_type/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public questionTypeIdGet(id: string): Observable<InlineResponse20035> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling questionTypeIdGet.'
      );
    }
   ...
   */
  public questionTypeIdPatch(id: string, item: Item110): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling questionTypeIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling questionTypeIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public questionTypeIdPut(id: string, item: Item109): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling questionTypeIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling questionTypeIdPut.'
      );
    }
   ...
   */
  public questionTypePost(item: Item108): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling questionTypePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/question_type`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
