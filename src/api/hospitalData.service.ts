...
import { Item90 } from '../model/item90';
import { Item91 } from '../model/item91';
import { Item92 } from '../model/item92';
...
export class HospitalDataService {
  ...
  public hospitalDataGet(
    ...
    filter?: Array<string>,
    satisfy?: string
  ): Observable<Array<InlineResponse20029>> {
    ...
    return this.httpClient.get<any>(`${this.basePath}/hospital_data`, {
   ...
   */
  public hospitalDataIdDelete(id: string): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling hospitalDataIdDelete.'
      );
    }
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/hospital_data/${encodeURIComponent(String(id))}`,
      {
        headers: headers,
        withCredentials: this.configuration.withCredentials
      }
   ...
   * @param id Identifier for item.
   */
  public hospitalDataIdGet(id: string): Observable<InlineResponse20029> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling hospitalDataIdGet.'
      );
    }
   ...
   */
  public hospitalDataIdPatch(id: string, item: Item92): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling hospitalDataIdPatch.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling hospitalDataIdPatch.'
      );
    }
   ...
   * @param item Properties of item to update.
   */
  public hospitalDataIdPut(id: string, item: Item91): Observable<number> {
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling hospitalDataIdPut.'
      );
    }
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling hospitalDataIdPut.'
      );
    }
   ...
   */
  public hospitalDataPost(item: Item90): Observable<number> {
    if (item === null || item === undefined) {
      throw new Error(
        'Required parameter item was null or undefined when calling hospitalDataPost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/hospital_data`, item, {
      headers: headers,
      withCredentials: this.configuration.withCredentials
    });
  }
